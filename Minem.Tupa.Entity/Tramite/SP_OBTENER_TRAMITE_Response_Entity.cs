...
{
    public class SP_OBTENER_TRAMITE_Response_Entity
    {
        ...
        public List<SP_OBTENER_REQUISITOS_TRAMITE_Response_Entity> Requisitos { get; set; }
    ...
    public class SP_OBTENER_REQUISITOS_TRAMITE_Response_Entity
    {
        ...
        //public string CostoFormatted {  get; set; }
